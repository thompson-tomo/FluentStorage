...
namespace FluentStorage {
	...
	public static class AzureFilesStorage {
		...
		/// </summary>
		public static AzureFilesStore FromClient(
		...
		public static AzureFilesStore FromCredentials(
		   string accountName,
		   string key) {
		...
		/// </summary>
		public static AzureFilesStore FromSharedKey(
		   string accountName,
		   string key,
		   Uri serviceUri) {
		...
		/// </summary>
		public static AzureFilesStore FromAzureAd(
		   string accountName,
		   string tenantId,
		...
		/// </summary>
		public static AzureFilesStore FromTokenCredential(
		   string accountName,
		...
		/// </summary>
		public static AzureFilesStore FromMsi(
		   string accountName,
		   AzureCloudEnvironment azureCloudEnvironment) {
		...
		/// Creates Azure Files with Managed Identity (Managed Service Identity)
		/// </summary>
		public static AzureFilesStore FromMsi(string accountName) {
