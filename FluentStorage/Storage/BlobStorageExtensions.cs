...
namespace FluentStorage.Storage {
	...
	public static class BlobStorageExtensions {
		...
		public static async Task<IReadOnlyCollection<StorageObject>> ListFilesAsync(this IBucket blobStorage,
		   ListOptions options,
		   CancellationToken cancellationToken = default) {
			IReadOnlyCollection<StorageObject> all = await blobStorage.ListAsync(options, cancellationToken).ConfigureAwait(false);
		...
		/// <param name="cancellationToken"></param>
		/// <returns>List of blob IDs</returns>
		public static Task<IReadOnlyCollection<StorageObject>> ListAsync(this IBucket blobStorage,
		...
		/// </summary>
		public static async Task<bool> ExistsAsync(this IBucket blobStorage,
		...
		public static async Task<StorageObject> GetBlobAsync(this IBucket storage,
		   string fullPath, CancellationToken cancellationToken = default) {
		...
		/// Set blob attributes
		/// </summary>
		public static Task SetBlobAsync(this IBucket storage,
		   StorageObject blob, CancellationToken cancellationToken = default) {
		...
		/// </summary>
		public static async Task WriteAsync(this IBucket provider, string fullPath, byte[] data, bool append = false, CancellationToken cancellationToken = default) {
			if (data == null) {
		...
		/// </summary>
		public static async Task<byte[]> ReadBytesAsync(this IBucket storage, string fullPath, CancellationToken cancellationToken = default) {
		...
		/// <param name="cancellationToken"></param>
		/// <returns></returns>
		public static async Task<T> ReadJsonAsync<T>(this IBucket storage,
		   string fullPath,
		...
		/// </summary>
		public static async Task<string> GetMD5HashAsync(this IBucket blobStorage, StorageObject blob, CancellationToken cancellationToken = default) {
			if (blob == null)
		...
		/// <param name="cancellationToken"></param>
		/// <returns></returns>
		public static async Task RenameAsync(this IBucket blobStorage,
		   string oldPath, string newPath, CancellationToken cancellationToken = default) {
			...
			if (blobStorage is IExtendedBlobStorage extendedBlobStorage) {
				...
				foreach (StorageObject item in await blobStorage.ListAsync(oldPath, recurse: true).ConfigureAwait(false)) {
					if (item.IsFile) {
