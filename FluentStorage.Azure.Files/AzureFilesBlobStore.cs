...
namespace FluentStorage.Azure.Files {
	class AzureFilesBlobStore : GenericBlobStorage {
		...
		public AzureFilesBlobStore(ShareServiceClient shareServiceClient, string accountName) {
			_client = shareServiceClient ?? throw new ArgumentNullException(nameof(shareServiceClient));
		}

		public static AzureFilesBlobStore CreateFromAccountNameAndKey(string accountName, string key) {
			return CreateFromAccountNameAndKey(accountName, key, null, default);
		}

		public static AzureFilesBlobStore CreateFromAccountNameAndKey(
		   string accountName,
		   string key,
		   Uri serviceUri,
